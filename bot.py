...
# --- Reddit API login ---
reddit = praw.Reddit(
    client_id=os.environ["HoP9daAk2nAkCWpd34-otQ"],
    client_secret=os.environ["HvsuaejMfbzqEy9ulhqv9gYhZEXXQA"],
    username=os.environ["EpsteinDidntCodeMe"],
    password=os.environ["EpsteinDidntCodeThis.2025"],
    user_agent="epsteindidntcodeme_v1 by u/{}".format(os.environ["PM_ME_YOUR_ROADCONES"])
)
